...
(:< s1 4 0 (play beat :cello (- @1 5) (cosr 60 10 7/4) dur :channel 7)
    `(,(scale 3 8 (r-elt '(-1 0 1 2)))
       ,(reverse (scale 3 8 (r-elt '(-1 0 1 2))))))

(:< s2 4 0 (play beat :cello (- @1 0) (cosr 60 10 7/4) dur :channel 1)
    `(,(scale 3 8 (r-elt '(-1 0 1 2)))
       ,(reverse (scale 3 8 (r-elt '(-1 0 1 2))))))
...
(:> p1 2 0 (play beat :Pizzicato-Strings @1 @2 dur :channel 2) (r-elt `((48 60) ((48 48) 60))) '(127 40))

(:> p1 2 0 (play beat :Pizzicato-Strings @1 @2 dur :channel 2) (elt `((48 60) ((48 _ _ 48) (60 48)) (48 (60 60))) (mod lc 2)) '(80 40))
...
(:< w2 3 0 (play beat :clarinet (if (numberp @1) (qnt (+ 7 @1)) '_) (cosr 60 10 7/4) dur :channel 4)
    `(,(hold h1 1 (r-elt '(((55 56) (58 60) (61 63) (65 67) 65 63)
                           (63 (62 63) 60 63 (62 63) 60)
                           (72 (72 72) (70 68) 67 (67 67) (65 63))
                           (65 (65 65) (67 65) 63 (62 63) 60)
